...
//		String[] line = str.split("。");
		...
		//学習データの読み取り
		String csvStudyInput = "C:\\pleiades\\workspace\\getStudyManModelTest\\src\\main\\java\\rcgaBatch1\\batch\\studyInput.txt";
		...
		String strOutputFile ="C:\\pleiades\\workspace\\getStudyManModelTest\\src\\main\\java\\rcgaBatch1\\batch\\nGramOutput.csv";
		...
		for (String key : studyMap.keySet()) {
			...
			StringBuilder sujoVector = new StringBuilder();
		...
		//該当文字前後の文字を出力
		String zengoGaitoMojiOutput ="C:\\pleiades\\workspace\\getStudyManModelTest\\src\\main\\java\\rcgaBatch1\\batch\\zengoGaitoMojiOutput.csv";
