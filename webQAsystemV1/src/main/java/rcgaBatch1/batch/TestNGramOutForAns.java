...
public class TestNGramOutForAns {
	...
	public static void main(String[] args) throws Exception {
		...
		String csvStudyInput = folderName + "ans_studyInput.txt";
		...
		String strOutputFile = folderName + "ans_nGramOutput.csv";
		...
		TestNGramOutForAns testNGramOut = new TestNGramOutForAns();
